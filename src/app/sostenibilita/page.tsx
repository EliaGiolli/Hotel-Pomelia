...
export const metadata: Metadata = {
  title: "Sostenibilità & Manifesto",
  description:
    "Il manifesto di Hotel Pomelia Ragusa: energia solare 100%, economia circolare, lenzuola GOTS biologiche, programma donazione biancheria e spiaggia accessibile certificata.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "100% energia rinnovabile, economia circolare, spiaggia barrier-free. Il lusso responsabile della Sicilia.",
    images: [
      {
