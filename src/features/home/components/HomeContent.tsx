...
const benefitPillars = [
  {
    icon: <SolarPowerIcon sx={{ fontSize: 28, color: "#F4C430" }} aria-hidden="true" />,
    label: "Energia solare 130%",
    detail: "Produciamo il 30% in più del nostro fabbisogno",
  },
  {
    icon: <RecyclingIcon sx={{ fontSize: 28, color: "#F4C430" }} aria-hidden="true" />,
    label: "87% rifiuti recuperati",
    detail: "Compost, riciclo, economia circolare",
  },
  {
    icon: <WaterDropIcon sx={{ fontSize: 28, color: "#F4C430" }} aria-hidden="true" />,
    label: "−40% consumo idrico",
    detail: "Sotto la media nazionale con raccolta piovana",
  },
  {
    icon: <AccessibleIcon sx={{ fontSize: 28, color: "#F4C430" }} aria-hidden="true" />,
